    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          'https://mavback-p9lg.onrender.com/api/onSales'
        )
    ...
    <div className="pt-[50px] overflow-x-hidden font-sans text-gray-900 bg-white">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4 bg-black/40">
          <h1 className="text-5xl font-extrabold drop-shadow-xl tracking-widest uppercase">
            Exclusive Collection
          </h1>
          <p className="text-lg mt-2 font-light text-gray-200">
            Up to <span className="text-white font-semibold">50% OFF</span> on
            selected styles
          </p>
          <p className="text-md mt-1 opacity-90 italic text-gray-300">
      ...
      <motion.div
        className="p-6 sm:p-8 md:p-10 bg-gray-50"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
